...
public class ApiAuthorizationFilterImpl implements ApiAuthorizationFilter {
	static Logger logger = LoggerFactory
			.getLogger(ApiAuthorizationFilterImpl.class);
	...
	private void initialize() {
		...
		classSecurityAnotations.put("/auth", false);
...
//		methodSecurityAnotations.put("GET:/store.{format}/order/{orderId}",
//				true);
//		methodSecurityAnotations.put("DELETE:/store.{format}/order/{orderId}",
//				true);
//		methodSecurityAnotations.put("POST:/store.{format}/order", true);
//		methodSecurityAnotations.put("POST:/user", false);
//		methodSecurityAnotations.put("POST:/user.{format}/createWithArray",
//				false);
//		methodSecurityAnotations.put("POST:/user.{format}/createWithList",
//				false);
